...
namespace Lugiano.Workflow.SyncService.Migrations
{
    ...
    [Migration("20260702193133_AddDoctorNoteSignedAtAndUpdatedAt")]
    partial class AddDoctorNoteSignedAtAndUpdatedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lugiano.Workflow.SyncService.Workflow.Models.EobScan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EobScan", (string)null);
                });

            modelBuilder.Entity("Lugiano.Workflow.SyncService.Workflow.Models.EobScanCheck", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EobScanId")
                        .HasColumnType("int");

                    b.Property<string>("HallucinationReason")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("PageNumber")
                        .HasColumnType("int");

                    b.Property<int?>("PairedCheckId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EobScanId", "PageNumber");

                    b.ToTable("EobScanCheck", (string)null);
                });

            modelBuilder.Entity("Lugiano.Workflow.SyncService.Workflow.Models.EobScanLineItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PatientNameRaw")
                        .HasMaxLength(400)
                        .HasColumnType("nvarchar(400)");
                    ...
                    b.ToTable("EobScanLineItem", (string)null);
                });
            ...
            modelBuilder.Entity("Lugiano.Workflow.SyncService.Workflow.Models.EobScanCheck", b =>
                {
                    b.HasOne("Lugiano.Workflow.SyncService.Workflow.Models.EobScan", null)
                        .WithMany("Checks")
                        .HasForeignKey("EobScanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
